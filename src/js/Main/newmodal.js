...
class NewModal extends React.Component {
        ...
        if (this.inputValid()) {
            ...
            axios({
                ...
                params: {
                    ...
                    type: abbrev,
                    regexList: temp,
                    uuid: this.props.getStore().userid,
                },
                ...
                .then(function (data) {
                    let entityList = that.props.getStore().entityList;
                    entityList.push({
                    ...
                    that.props.updateStore(entityList);
                    that.clearState();
    ...
    render() {
        ...
        const {regexList, name, abbrev} = this.state;
        const {getStore, updateStore, closeModel, ...rest} = this.props;
        return (
            <Modal
                {...rest}
                size="lg"
